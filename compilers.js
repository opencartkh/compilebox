...
exports.compilerArray = [
    ...
    ["'ls -l \"'\"/root/.local/share/umake/kotlin/kotlin-lang/bin/kotlinc-jvm\"'\" # -src main.kt -jar main.jar'", "main.kt", 'java -cp "kotlinc/lib/*:main.jar" namespace', "Kotlin", ""],     // kotlinc is a repl
